...
const copy: Record<Lang, Copy> = {
  pt: {
    nav: {
      how: "Como funciona",
      packs: "Pacotes",      rights: "Direitos autorais",
      faq: "Perguntas",
      contact: "Contato",
    },
    hero: {
  ...
  en: {
    nav: {
      how: "How it works",
      packs: "Packages",      rights: "Copyright",
      faq: "FAQ",
      contact: "Contact",
    },
    hero: {
    ...
    <div className="sticky top-0 z-50 backdrop-blur bg-white/80 border-b border-neutral-200">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6 text-sm text-neutral-700">
          ...
          <a href="#packs" className="hover:text-neutral-900">{t.nav.packs}</a>          <a href="#rights" className="hover:text-neutral-900">{t.nav.rights}</a>
  ...
  <div className="mx-auto max-w-6xl px-6">
    <div className="mb-8 text-center">
      ...
      <p className="mt-3 text-neutral-600">
        Histórias, versos e bastidores criativos do universo Cante sua Vida.
      </p>
    </div>
...
<script
  src="https://app.trysoro.com/api/embed/a86f1ceb-1564-41b1-bd74-8993002d1e9c"
  defer
></script>
