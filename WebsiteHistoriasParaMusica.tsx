...
const copy: Record<Lang, Copy> = {
  pt: {
    ...
    rights: {
      title: "Direitos autorais (simples)",
      bullets: [
    ...
    contact: {
      title: "Contato",
      subtitle:
        "Para dúvidas, propostas comerciais ou campanhas, fale comigo por WhatsApp/Instagram/e-mail.",
      fieldsNote:
        "Dica: use um formulário (Typeform/Tally/Google Forms) para coletar a história após o pagamento.",
      whatsapp: "WhatsApp",
      instagram: "Instagram",
      email: "E-mail",
      phoneHint: "(coloque seu número)",
...
const LogoMark = ({ className = "" }: { className?: string }) => (
  <div
    className={
      "h-9 w-9 rounded-2xl bg-neutral-900 text-white flex items-center justify-center shadow-sm " +
      className
    }
    aria-label="Logo"
    title="Cante sua Vida"
    ...
    <div id="top" className="min-h-screen bg-neutral-50 text-neutral-900">
            ...
            return (
              <Card key={p.id} className="p-6 flex flex-col">
                ...
                <p className="mt-3 text-xs text-neutral-500">
                  {lang === "pt"
                    ? "PIX (Brasil) • cartão/boleto • entrega digital"
      ...
      <Section id="rights" title={t.rights.title}>
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <Card className="p-6">
            ...
            >
              {lang === "pt" ? "Pedir proposta" : "Request quote"}{" "}
              <ChevronRight className="h-4 w-4" />
            </a>
          </Card>
        </div>
            ...
            <div className="grid sm:grid-cols-3 gap-3">
              <a
                ...
                onClick={(e) => {
                  ...
                  window.alert(
                    lang === "pt"
                      ? "Troque este link pelo seu Instagram."
                      : "Replace this link with your Instagram."
                  );
                }}
              >
                <div className="flex items-center gap-2 text-sm font-semibold">
                  <Instagram className="h-4 w-4" /> {t.contact.instagram}
                </div>
              ...
              <a
                ...
                onClick={(e) => {
                  ...
                  window.alert(
                    lang === "pt"
                      ? "Troque este link pelo seu e-mail (mailto:)."
                      : "Replace this link with your email (mailto:)."
                  );
                }}
              >
                <div className="flex items-center gap-2 text-sm font-semibold">
                ...
                <div className="mt-1 text-sm text-neutral-600">{t.contact.emailHint}</div>
              </a>
              ...
              <a
                ...
                onClick={(e) => {
                  ...
                  window.alert(
                    lang === "pt"
                      ? "Troque este link pelo seu WhatsApp (wa.me/)."
                      : "Replace this link with your WhatsApp (wa.me/)."
                  );
                }}
              >
                <div className="flex items-center gap-2 text-sm font-semibold">
                ...
                <div className="mt-1 text-sm text-neutral-600">{t.contact.phoneHint}</div>
              </a>
            </div>

            <div className="mt-4 rounded-2xl bg-neutral-50 border border-neutral-200 p-4 text-xs text-neutral-600">
              {t.contact.fieldsNote}
            </div>
          </Card>

          <Card className="p-6">
            <div className="text-sm font-semibold">{lang === "pt" ? "Próximo passo" : "Next step"}</div>
            <p className="mt-2 text-sm text-neutral-600">
              {lang === "pt"
                ? "Após pagar, clique no link do formulário e conte sua história."
                : "After paying, click the form link and share your story."}
            </p>
            <div className="mt-4">
              <AnchorButton href="#packs" variant="primary">
                {lang === "pt" ? "Voltar aos pacotes" : "Back to packages"}
              </AnchorButton>
            </div>
          </Card>
        </div>
      ...
      <footer className="border-t border-neutral-200 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="mt-6 flex flex-wrap gap-3 text-xs text-neutral-500">
            ...
            <span>•</span>
            <a className="hover:text-neutral-900" href="#packs">{t.nav.packs}</a>
            <span>•</span>
            <a className="hover:text-neutral-900" href="#samples">{t.nav.samples}</a>
            <span>•</span>
            <a className="hover:text-neutral-900" href="#testimonials">{t.nav.testimonials}</a>
            <span>•</span>
            <a className="hover:text-neutral-900" href="#rights">{t.nav.rights}</a>
            <span>•</span>
            <a className="hover:text-neutral-900" href="#faq">{t.nav.faq}</a>
            <span>•</span>
            <a className="hover:text-neutral-900" href="#contact">{t.nav.contact}</a>
          </div>
        </div>
      </footer>
      ...
      <div className="fixed bottom-4 left-0 right-0 z-40 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="rounded-2xl border border-neutral-200 bg-white/90 backdrop-blur shadow-lg p-3 flex items-center justify-between gap-3">
            <div className="text-sm text-neutral-700">
              <span className="font-semibold">{t.ctaSticky}</span>
              <span className="ml-2 text-neutral-500 hidden sm:inline">
                • {lang === "pt" ? "PIX disponível via banco" : "PIX via bank app"}
              </span>
            </div>
            <a
              href="#packs"
              className="inline-flex items-center justify-center gap-2 rounded-2xl bg-neutral-900 text-white px-4 py-2 text-sm font-medium hover:bg-neutral-800"
            >
              {lang === "pt" ? "Ver pacotes" : "See packages"} <ChevronRight className="h-4 w-4" />
            </a>
          </div>
        </div>
      </div>
